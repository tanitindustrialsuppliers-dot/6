        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="space-y-2 pt-2 text-xs">
            <div className="flex items-start gap-2.5 text-slate-300">
              ...
              <span>Headquarters & Manufacturing Plant: Zone Industrielle Ben Arous, Tunis / Frankfurt / Dubai Silicon Oasis</span>
            </div>
            <div className="flex items-center gap-2.5 text-slate-300">
              <Phone className="w-4 h-4 text-emerald-400 shrink-0" />
              <span>+216 71 800 900 / +49 89 2100 400 (Global Engineering Desk)</span>
            </div>
            <div className="flex items-center gap-2.5 text-slate-300">
              <Mail className="w-4 h-4 text-cyan-400 shrink-0" />
              <span>tanitindustrialsuppliers@gmail.com / sales@tanitmetal.com</span>
            </div>
          </div>
        </div>
