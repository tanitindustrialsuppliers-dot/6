    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 space-y-3 shadow-sm text-center">
          ...
          <h3 className="font-bold text-slate-900 text-base">International Logistics</h3>
          <p className="text-xs text-slate-600 leading-relaxed">
            Manufacturing facilities in Ben Arous (Tunis), logistics hubs in Frankfurt & Dubai, serving customers in over 45 countries.
          </p>
        </div>
      </div>
    </div>
